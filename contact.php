...
if(isset($_POST['message']) and isset($_POST['name'])) {
	...
	if(empty($errors)) {
		if (mail($your_email, $subject, $message, $from)) {
			echo '<img src="example/Gevectoriseerd Logo BXLounge2.png" style="width: 60%;" alt="">
			<a class="navbar-brand" href="http://bxl-rent.ch/">вернуться</a>';
		} else {
